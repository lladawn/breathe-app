      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div
          className="bg-[#f4f1eb] bg-opacity-70 
            rounded-lg shadow p-4 h-[40vh] overflow-y-auto
            shadow-inner
            transition-all"
          style={{
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm text-[#6b665f] mb-3">
                ...
                are little songs I’ve shaped using{" "}
                <span className="font-semibold italic">Suno </span> — fragments
                of emotion, made into sound.
              </p>
              <a
